...
var _buttonAccordion = require("./modules/button-accordion.js");
var _commentsSlider = require("./modules/comments-slider.js");
var _heroSlider = require("./modules/hero-slider.js");
var _navigation = require("./modules/navigation.js");
var _newsSlider = require("./modules/news-slider.js");
var _programs__slider = require("./modules/programs__slider.js");
var _removeFocusSubmenuLink = require("./modules/removeFocusSubmenuLink.js");
...
var _burger = require("./vendor/burger.js");
var _initAccordion = require("./vendor/init-accordion.js");
var _customSelect = require("./vendor/custom-select/custom-select.js");
var _newsButtonCategoty = require("./modules/news-button-categoty.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _removeFocusSubmenuLink.removeFocusOnSubmenu)();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _programs__slider.initProgramsSlider)();
    (0, _navigation.toggleMenuHandler)();
    var select = new _customSelect.CustomSelect();
    select.init();
    (0, _newsSlider.initNewsSlider)();
    (0, _newsButtonCategoty.changeClassNewsCategoryButton)();
    (0, _buttonAccordion.changeClassButtonAccordion)();
    (0, _commentsSlider.initCommentsSlider)();
  });
});
...
},{"./modules/button-accordion.js":2,"./modules/comments-slider.js":3,"./modules/form-validate/form":5,"./modules/hero-slider.js":11,"./modules/modals/init-modals":12,"./modules/navigation.js":14,"./modules/news-button-categoty.js":15,"./modules/news-slider.js":16,"./modules/programs__slider.js":17,"./modules/removeFocusSubmenuLink.js":18,"./utils/ios-vh-fix":22,"./vendor/burger.js":25,"./vendor/custom-select/custom-select.js":27,"./vendor/init-accordion.js":30}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.changeClassButtonAccordion = void 0;
var buttons = document.querySelectorAll('.faq__inner-item-button');
var changeClassButtonAccordion = function changeClassButtonAccordion() {
...
exports.changeClassButtonAccordion = changeClassButtonAccordion;
...
exports.initCommentsSlider = void 0;
var Swiper = window.Swiper;
var slider = document.querySelector('.comments__slider');
var initCommentsSlider = function initCommentsSlider() {
  return slider && new Swiper('.comments__slider', {
    navigation: {
...
exports.initCommentsSlider = initCommentsSlider;
...
var initHeroSlider = function initHeroSlider() {
  return slider && new Swiper('.hero__slider', {
    loop: true,
    slidesPerView: 1,
    spaceBetween: 0,
    pagination: {
...
},{"../../utils/focus-lock":19,"../../utils/scroll-lock":23}],14:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toggleMenuHandler = void 0;
var header = document.querySelector('.header');
var headerInner = header.querySelector('.header__inner');
var navigationToggle = document.querySelector('.navigation__button');
var body = document.querySelector('body');
var menuLinks = document.querySelectorAll('.navigation__list-item-link');
var toggleMenuHandler = function toggleMenuHandler() {
  menuLinks.forEach(function (link) {
    return link.addEventListener('click', closeModal);
  });
...
exports.changeClassNewsCategoryButton = void 0;
var container = document.querySelector('.news__box-inner-button-category');
var currentButton = container.querySelector('.news__button-category--current');
var changeClassNewsCategoryButton = function changeClassNewsCategoryButton() {
...
exports.changeClassNewsCategoryButton = changeClassNewsCategoryButton;
...
var _focusSlider = require("./../utils/focusSlider.js");
var Swiper = window.Swiper;
var slider = document.querySelector('.programs__slider');
var initProgramsSlider = function initProgramsSlider() {
  if (slider) {
    var program = new Swiper('.programs__slider', {
      navigation: {
    ...
    (0, _focusSlider.focusSlider)(slider, program);
  }
};
exports.initProgramsSlider = initProgramsSlider;

},{"./../utils/focusSlider.js":20}],18:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeFocusOnSubmenu = void 0;
var navigationList = document.querySelector('.navigation-list');
var btnSubMenu = navigationList.querySelectorAll('.navigation-list__item-link-submenu');
var removeFocusOnSubmenu = function removeFocusOnSubmenu() {
  btnSubMenu.forEach(function (item) {
    return item.addEventListener('click', function () {
      return item.closest('.navigation-list__item').querySelector('.navigation-list__sublist').classList.toggle('sublist-active');
    });
  });
};
exports.removeFocusOnSubmenu = removeFocusOnSubmenu;
...
exports.focusSlider = void 0;
var focusSlider = function focusSlider(iSlider, swiper) {
  var links = iSlider.querySelectorAll('a');
  var func = function func(evt) {
    var slides = iSlider.querySelectorAll('.swiper-slide');
    var iTarget = evt.target.closest('.swiper-slide');
    var index = Array.from(slides).indexOf(iTarget);
...
exports.focusSlider = focusSlider;
...
},{"./focus-lock":29,"./scroll-lock":32}],26:[function(require,module,exports){
"use strict";
...
},{"./accordions":24}],31:[function(require,module,exports){
arguments[4][21][0].apply(exports,arguments)
},{"dup":21}],32:[function(require,module,exports){
arguments[4][23][0].apply(exports,arguments)
},{"./ios-checker":31,"dup":23}]},{},[1])
